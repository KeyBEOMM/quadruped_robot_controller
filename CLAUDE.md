...
| **세션 종료** | 유의미한 작업 후 종료 또는 "저장/마무리/끝" | `context/session/05_active_context.md` + `context/session/06_progress.md` 갱신; 신규 Gotcha는 `> [Gotcha 제안]` 블록으로 제시 (CLAUDE.md §6 직접 수정 금지) |
